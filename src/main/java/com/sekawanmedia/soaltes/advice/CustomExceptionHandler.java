package com.sekawanmedia.soaltes.advice;
import com.fasterxml.jackson.databind.exc.InvalidFormatException;
import com.sekawanmedia.soaltes.exception.ResourceNotFoundException;
import com.sekawanmedia.soaltes.utils.ErrorRespone;
...
public class CustomExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        List<String> errors = ex.getBindingResult().getAllErrors().stream()
                ...
                .map(err -> camelToSnake(String.valueOf(err.getConstraintDescriptor())) + " "
                        + err.getMessage())
